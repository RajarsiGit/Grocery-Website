	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			<div class="w3l_banner_nav_right_banner5">
				<h3>Best Deals For Fresh Fruits<span class="blink_me"></span></h3>
			</div>
			<div class="w3l_banner_nav_right_banner3_btm">
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml" style="cursor: pointer;" onclick="location.href='/fruits';">
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml" style="cursor: pointer;" onclick="location.href='/dryfruits';">
					<div class="view view-tenth">
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml" style="cursor: pointer;" onclick="location.href='/vegetables';">
					<div class="view view-tenth">
